...
abstract class BazaarRepository {
  ...
  Future<Either<Failure, BazaarModel>> createBazaar(Map<String, dynamic> body);
  ...
  Future<Either<Failure, void>> reviewBazaar(String sellerId, String status, {String? rejectionReason});
}
